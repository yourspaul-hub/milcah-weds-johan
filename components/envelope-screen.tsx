    ...
    <AnimatePresence>
      {!clicked && (
        <motion.div
          ...
          style={{ background: "linear-gradient(160deg, #FBF7EF 0%, #E8D4D0 45%, #C08B8B 100%)" }}
          onClick={handleClick}
        >
          {petals.map(p => (
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at center, rgba(95,106,86,0.1) 0%, transparent 65%)" }} />

          <div className="absolute inset-8 pointer-events-none rounded-sm" style={{ border: "1px solid rgba(95,106,86,0.3)" }} />
          <div className="absolute inset-10 pointer-events-none rounded-sm" style={{ border: "1px solid rgba(95,106,86,0.15)" }} />
          ...
          >
            <div className="flex items-center gap-3 mb-8 w-full">
              <div className="flex-1 h-px" style={{ background: "linear-gradient(90deg, transparent, rgba(95,106,86,0.6))" }} />
              <span style={{ color: SAGE, fontSize: 18 }}>✦</span>
              <div className="flex-1 h-px" style={{ background: "linear-gradient(90deg, rgba(95,106,86,0.6), transparent)" }} />
            </div>

            <p className="font-cormorant italic text-sm mb-6" style={{ color: SAGE_SOFT }}>
              {weddingConfig.messages.scripture}
              <br />
              <span style={{ fontSize: "0.78rem", opacity: 0.85 }}>{weddingConfig.messages.scriptureRef}</span>
            </p>

            <p className="font-sans text-xs tracking-widest uppercase mb-5" style={{ color: SAGE, letterSpacing: "0.35em" }}>
            ...
            <p className="font-cormorant italic text-xl mb-2" style={{ color: SAGE_SOFT }}>&amp;</p>
            <h1
              className="mb-6"
              style={{
                fontFamily: "'Great Vibes', cursive",
            ...
            <p className="font-playfair tracking-widest mb-2" style={{ color: SAGE, letterSpacing: "0.2em", fontSize: "1.1rem" }}>
            ...
            <motion.div animate={{ opacity: [0.5, 1, 0.5], y: [0, -4, 0] }} transition={{ duration: 2.2, repeat: Infinity }}
              ...
              <div className="px-7 py-2.5 rounded-full font-sans text-xs tracking-widest uppercase"
                style={{ border: "1px solid rgba(95,106,86,0.5)", color: SAGE, letterSpacing: "0.25em" }}>
                Open Invitation
              </div>
              <span style={{ color: "rgba(95,106,86,0.65)", fontSize: 10, letterSpacing: "0.15em" }}>tap anywhere to continue</span>
            </motion.div>
          </motion.div>
        </motion.div>
      )}
