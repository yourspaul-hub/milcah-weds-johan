...
export function FooterSection() {
  return (
    <section style={{ background: "linear-gradient(180deg,#E4D6BA,#D9C7A3)" }} className="pt-16 pb-10 px-6">
      <div className="max-w-lg mx-auto text-center">
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          className="font-cormorant italic text-lg mb-6" style={{ color: "rgba(176,141,87,0.85)" }}>
        ...
        <motion.p initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
          className="font-playfair mb-10" style={{ fontSize: "clamp(1.1rem,3.5vw,1.4rem)", fontStyle: "italic", color: "#3E362E" }}>
        ...
        <motion.h2 initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}
          className="mb-1"
          style={{ fontFamily: "'Great Vibes',cursive", fontSize: "clamp(2.8rem,10vw,4.5rem)", color: "#3E362E", lineHeight: 1.1 }}>
        ...
        <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
          className="font-cormorant italic text-2xl" style={{ color: "rgba(176,141,87,0.85)" }}>
          &amp;
        </motion.span>
        ...
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}
          className="font-sans text-xs mb-2" style={{ color: "rgba(62,54,46,0.65)" }}>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.7 }}
          ...
          <div className="h-px flex-1" style={{ background: "linear-gradient(90deg,transparent,rgba(176,141,87,0.4))" }} />
          <Heart size={16} className="heartbeat" style={{ color: "#B08D57" }} fill="#B08D57" />
          <div className="h-px flex-1" style={{ background: "linear-gradient(90deg,rgba(176,141,87,0.4),transparent)" }} />
        </motion.div>

        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.8 }}
          className="font-sans text-[11px] mt-6 tracking-widest uppercase" style={{ color: "rgba(62,54,46,0.45)", letterSpacing: "0.2em" }}>
