...
export function FooterSection() {
  return (
    <section style={{ background: "linear-gradient(180deg,#5F6A56,#4B5545)" }} className="pt-16 pb-10 px-6">
      <div className="max-w-lg mx-auto text-center">
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          className="font-cormorant italic text-lg mb-6" style={{ color: "#E8D9BB" }}>
        ...
        <motion.p initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
          className="font-playfair mb-10" style={{ fontSize: "clamp(1.1rem,3.5vw,1.4rem)", fontStyle: "italic", color: "#FBF7EF" }}>
        ...
        <motion.h2 initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}
          className="mb-1"
          style={{ fontFamily: "'Great Vibes',cursive", fontSize: "clamp(2.8rem,10vw,4.5rem)", color: "#FBF7EF", lineHeight: 1.1 }}>
        ...
        <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
          className="font-cormorant italic text-2xl" style={{ color: "#E8D9BB" }}>
          &amp;
        </motion.span>
        ...
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.45 }}
          className="font-playfair mt-2 mb-1" style={{ color: "#E8D9BB", letterSpacing: "0.18em", fontSize: "1.05rem" }}>
          {weddingConfig.wedding.dotDate}
        </motion.p>
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }}
          className="font-sans text-xs mb-2" style={{ color: "rgba(251,247,239,0.85)" }}>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.7 }}
          ...
          <div className="h-px flex-1" style={{ background: "linear-gradient(90deg,transparent,rgba(232,217,187,0.5))" }} />
          <Heart size={16} className="heartbeat" style={{ color: "#E8D9BB" }} fill="#E8D9BB" />
          <div className="h-px flex-1" style={{ background: "linear-gradient(90deg,rgba(232,217,187,0.5),transparent)" }} />
        </motion.div>

        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.8 }}
          className="font-sans text-[11px] mt-6 tracking-widest uppercase" style={{ color: "rgba(251,247,239,0.65)", letterSpacing: "0.2em" }}>
